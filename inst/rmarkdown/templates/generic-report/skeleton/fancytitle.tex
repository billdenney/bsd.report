...
\def\@maketitle{%
  ...
  \fi
  Author:  & \@author \\
  Author Contact information: & \begin{minipage}[t]{0.5\columnwidth}Human Predictions, LLC\par Boston, MA 02115\par United States\end{minipage} \\
  Report Date: & \@date \\
  \ifdefined\reportnumber
  ...
  \let \footnote \thanks
    ...
    \rule{0pt}{2cm} \TextField[name=authorsign, width=8cm]{} & \TextField[name=authordate, width=4cm]{} & Author \\
    \@author & & \\
    \ifdefined\reviewername
    \rule{0pt}{2cm} \TextField[name=reviewersign, width=8cm]{} & \TextField[name=reviewerdate, width=4cm]{} & Reviewer \\
    \reviewername & & \\
    \fi
    \ifdefined\approvername
    \rule{0pt}{2cm} \TextField[name=approversign, width=8cm]{} & \TextField[name=approverdate, width=4cm]{} & Approver \\
    \approvername & & \\
    \fi
    \end{tabular}
  \end{center}
